...
@Slf4j
@Component
public class PositiveStationSevenListener implements MonitoredDataItemListener {
    @Inject
    ...
    @Async("taskExecutor")
    private void positiveStationSevenWebsocket(MonitoredDataItem monitoredDataItem, DataValue dataValue, DataValue dataValue1) {
    ...
    public void onDataChange(MonitoredDataItem monitoredDataItem, DataValue dataValue, DataValue dataValue1) {
        log.info("正面工位7被触发VacuumPumpListener monitoredDataItem= " + monitoredDataItem + ";dataValue=" + dataValue + ";dataValue1=" + dataValue1);
        taskExecutor.execute(()->positiveStationSevenWebsocket(monitoredDataItem,dataValue,dataValue1));
    }
}
