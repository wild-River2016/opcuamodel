...
@Slf4j
@Component
public class OppositeStationTwelveListener  implements MonitoredDataItemListener {
    ...
    @Async("taskExecutor")
    private void OppositeStationTwelveWebsocket(MonitoredDataItem monitoredDataItem, DataValue dataValue, DataValue dataValue1) {
    ...
    public void onDataChange(MonitoredDataItem monitoredDataItem, DataValue dataValue, DataValue dataValue1) {
        log.info("机器人状态被触发 MainLineOfVacuumPumpingListener monitoredDataItem= " + monitoredDataItem + ";dataValue=" + dataValue + ";dataValue1=" + dataValue1);
        taskExecutor.execute(() -> OppositeStationTwelveWebsocket(monitoredDataItem, dataValue, dataValue1));
    }
}
